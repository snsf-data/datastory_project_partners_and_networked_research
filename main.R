...
datastory_name <- "project_partners_and_networked_research"
...
# characters etc.)
# -> Don't put "datastory" at the start or end!
datastory_name_en <- "project-partners-and-networked-research"
datastory_name_de <- "projektpartnerschaften-und-vernetzte-forschung"
datastory_name_fr <- "partenaires-de-projet-et-recherche-en-reseau"

# English title and lead of the story (Mandatory, even if no EN version)
title_en <- "More networked research thanks to project partners: a look at the first years"
lead_en <- "Since 2017, project partners can contribute to specific aspects of research projects supported by the SNSF’s Project funding scheme. What trends do we observe?"
# German title and lead of the story (Mandatory, even if no DE version)
title_de <- "Besser vernetzt dank Projektpartnerschaften: Blick zurück auf die ersten Jahre"
lead_de <- "Seit 2017 können in der Projektförderung des SNF Projektpartner:innen zu spezifischen Aspekten der Forschung beitragen. Wie häufig sind solche Partnerschaften?"
# French title and lead of the story (Mandatory, even if no FR version)
title_fr <- "Recherche en réseau renforcée grâce aux partenaires de projet : un premier bilan"
lead_fr <- "Depuis 2017, les partenaires de projet peuvent contribuer à certains aspects spécifiques des projets de recherche bénéficiant de subsides d’encouragement du FNS. Quelles tendances observons-nous ?"
...
publication_date <- "2023-03-01 04:00:00"
...
doi_url <- "https://doi.org/10.46446/datastory.project-partners-and-networked-research"
# URL to Github page (optional)
github_url <- "https://github.com/snsf-data/datastory_project_partners_and_networked_research"
